<div class="flex justify-between items-center bg-gray-100 p-4 shadow-md">
    ...
    <div class="flex items-center">
        ...
        <nav class="hidden md:flex space-x-6 ml-8">
            ...
            @else
                <a href="{{ route('login') }}" class="text-gray-700 hover:text-green-500 font-semibold">Login</a>
                <a href="{{ route('register') }}" class="text-gray-700 hover:text-green-500 font-semibold">Register</a>
            @endauth
    ...
    <div class="flex items-center space-x-4">
        @auth
            ...
            <!-- User Avatar -->
            <div class="relative">
                <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : 'https://via.placeholder.com/40' }}" alt="User Avatar" class="h-10 w-10 rounded-full cursor-pointer" id="profileDropdownToggle">
