...
<div class="bg-white shadow rounded-lg p-6 mb-8 flex flex-col md:flex-row justify-between items-center">
    <div class="text-center mb-4 md:mb-0">
        ...
        <p class="text-green-500 text-xl font-semibold">GHC {{ number_format($user->deposits->sum('amount'), 2) }}</p>
    </div>
    ...
    <div class="text-center">
        ...
        <p class="text-green-500 text-xl font-semibold">GHC {{ number_format($user->balance, 2) }}</p>
    </div>
</div>
        ...
        <li class="border-b border-gray-200 pb-2">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-green-500 font-semibold">GHC{{ number_format($order->amount, 2) }}</span>
                    @if($order->attachment)
    ...
    <ul class="space-y-4">
        ...
        <li class="border-b border-gray-200 pb-2">
            <div class="flex justify-between">
                ...
                <span class="text-green-500 font-semibold">GHC  {{ number_format($deposit->amount, 2) }}</span>
            </div>
        </li>
        @endforeach
    </ul>
